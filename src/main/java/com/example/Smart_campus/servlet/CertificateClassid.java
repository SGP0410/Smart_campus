...
/**
 * @author 关鑫
 * @date 2021/8/16 10:51 星期一
 * @Description com.example.Smart_campus.servlet
 */
@WebServlet(name = "GetCertificateClassid",value = "/GetCertificateClassid")
public class CertificateClassid extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ServletUtils.Setting(req, resp);
        JSONObject jsonObject = ServletUtils.getJSONObject(req);
        List<Certificate> classid = new CertificateDaoImpl().queryClassid(jsonObject.optString("classid"));
