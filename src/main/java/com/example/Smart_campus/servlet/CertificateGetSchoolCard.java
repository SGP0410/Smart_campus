...
/**
 * @author 关鑫
 * @date 2021/8/15 11:14 星期日
 * @Description com.example.Smart_campus.servlet
 */
@WebServlet(name = "GetCertificateSchoolCard",value = "/GetCertificateSchoolCard")
public class CertificateGetSchoolCard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (schoolcard != null) {
            jsonObject1.put("total",schoolcard.size());
